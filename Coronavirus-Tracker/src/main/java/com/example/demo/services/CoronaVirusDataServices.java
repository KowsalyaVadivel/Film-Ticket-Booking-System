...
public class CoronaVirusDataServices 
{
	...
	@Autowired
	private CoronavirusDataServicerRepository repository;
    ...
    // Exact count match
    public List<LocationStates> getCountriesByLatestTotalDeaths(int count) {
        return repository.findByLatestTotalDeaths(count);
    }

    // Top N countries by deaths
    public List<LocationStates> getTopCountriesByDeaths(int topN) {
        return repository.findAllByOrderByLatestTotalDeathsDesc()
                         .stream()
                         .limit(topN)
    ...
    public Optional<LocationStates> getLocationById(Long id) {
        return repository.findById(id);
    }
	public List<LocationStates> findByCountryIgnoreCase(String country) {
